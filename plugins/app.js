...
export default () => {
    ...
    library.add(faTwitter, faGithub, faLinkedin, faInstagram, faFacebook, faDiscord, faArrowAltCircleDown, faHandPointRight, faUserSecret, faFileArrowDown, faArrowUp, faShekelSign, faMusic, faMusicSlash, faArrowLeftFromLine, faSun, faMoonCloud)
